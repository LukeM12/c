  ...
  while(1) {
    ...
    while(read_line(newSd,line)!=ERROR) {
      ...
      printf("%s: received from %s:TCP%d : %s\n", argv[0], 
	     ...
	     /*  inet_aton() converts the Internet host address cp from  the  IPv4  numbers and dots form to a binary form. It of course does this in network byte order, and stores it in the structure that inp points to which is of type 
struct in_addr type */
      /* init line */
      memset(line,0x0,MAX_MSG);
